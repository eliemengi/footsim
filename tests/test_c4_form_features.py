...
class TestVertraege:
    ...
    def test_die_fassung_ist_mindestens_die_von_c4(self):
        """
        C4 hat die Fassung auf 3 gehoben. Spaetere Bloecke heben sie
        weiter - C5 auf 4. Geprueft wird deshalb die Untergrenze und
        nicht die Gleichheit: Ein sinkender Wert waere ein Fehler, ein
        steigender ist der Normalfall.
        """
